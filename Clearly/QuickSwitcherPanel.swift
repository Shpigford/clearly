...
final class QuickSwitcherManager: NSObject {
    ...
    private func createPanel() {
        ...
        field.placeholderString = L10n.string(
            "quickSwitcher.searchPlaceholder",
        ...
        if query.isEmpty {
            ...
            if items.isEmpty {
                ...
                items = [QuickSwitcherItem(
                    filename: L10n.format(
                        "quickSwitcher.createFormat",
                        defaultValue: "Create %@",
                        createName
                    ),
        ...
        if item.isCreateNew {
            iconView.image = NSImage(
                ...
                accessibilityDescription: L10n.string(
                    "quickSwitcher.accessibility.create",
                    defaultValue: "Create"
                )
            )
            ...
            iconView.image = NSImage(
                ...
                accessibilityDescription: L10n.string(
                    "quickSwitcher.accessibility.document",
...
private class QuickSwitcherContentCellView: NSView {
    ...
    func configure(with item: QuickSwitcherItem) {
        iconView.image = NSImage(
            ...
            accessibilityDescription: L10n.string(
                "quickSwitcher.accessibility.contentMatch",
                defaultValue: "Content match"
            )
        )
        iconView.contentTintColor = .tertiaryLabelColor
