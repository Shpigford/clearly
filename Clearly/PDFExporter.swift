...
final class PDFExporter: NSObject, WKNavigationDelegate {
    ...
    func exportPDF(markdown: String, fontSize: CGFloat, previewTypography: PreviewTypography = .default, fileURL: URL? = nil) {
        ...
        documentURL = fileURL
        isPrint = false
        loadHTML(markdown: markdown, fontSize: fontSize, previewTypography: previewTypography)
    }

    func printHTML(markdown: String, fontSize: CGFloat, previewTypography: PreviewTypography = .default, fileURL: URL? = nil) {
        PDFExporter.current = self
        exportURL = nil
        documentURL = fileURL
        isPrint = true
    ...
    private func loadHTML(markdown: String, fontSize: CGFloat, previewTypography: PreviewTypography) {
        ...
        <head>
        <meta charset="utf-8">
        <style>\(PreviewCSS.css(fontSize: fontSize, typography: previewTypography, forExport: false))</style>
        </head>
        <body>\(htmlBody)</body>
