...
import { EditorState, RangeSetBuilder, Compartment, StateField, type Extension } from "@codemirror/state";
import {
  search,
  searchKeymap,
  SearchQuery,
